...
<head>
	<title>Stretch an Education Category Bootstrap responsive WebTemplate | Services :: w3layouts</title>
				...
				<nav class="navbar navbar-default">
					...
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="index.php
                                                       ">Stretch <span>Online Education</span></a></h1>
					</div>
	...
	<div class="contact-footer-w3layouts-agile">
		...
		<div class="copy-w3-agileits">
			<h2 class="footer-logo"><a href="index.php
                                                   ">Stretch <span>Online Education</span></a></h2>
